      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA001.
       MAIN SECTION.
           PERFORM R001-INIT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA001 TO W-LPETA001

           MOVE N'00' TO RETURNCODE OF W-LPETA001
           MOVE N'00' TO REASONCODE OF W-LPETA001
           MOVE SPACES TO INFOMESSAGE OF W-LPETA001
           .
       R001-INIT-END. 
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA001 NOT = N'C'
           AND OPCODE OF W-LPETA001 NOT = N'R'
           AND OPCODE OF W-LPETA001 NOT = N'U'
           AND OPCODE OF W-LPETA001 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'01' TO REASONCODE OF W-LPETA001
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA001
           END-IF

           IF  RETURNCODE OF W-LPETA001 = N'00'
           AND TABLEID OF W-LPETA001 = SPACES
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'02' TO REASONCODE OF W-LPETA001
              MOVE N'TABLEID is required' TO INFOMESSAGE OF W-LPETA001
           END-IF

           IF  RETURNCODE OF W-LPETA001 = N'00'
           AND TABKEY OF W-LPETA001 = SPACES
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'03' TO REASONCODE OF W-LPETA001
              MOVE N'TABKEY' TO INFOMESSAGE OF W-LPETA001
           END-IF

           IF OPCODE OF W-LPETA001 = N'C'
           OR OPCODE OF W-LPETA001 = N'U'
              IF CREATEDBY OF W-LPETA001 = SPACES
              OR CREATEDBY OF W-LPETA001 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA001 = SPACES
              OR UPDATEDBY OF W-LPETA001 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA001 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA001
                    END-IF

                    IF UPDATEDBY OF W-LPETA001 = SPACES
                    OR UPDATEDBY OF W-LPETA001 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA001
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA001
                    MOVE N'90' TO REASONCODE OF W-LPETA001
                    MOVE INFOMESSAGE OF W-LPETA900 TO
                         INFOMESSAGE OF W-LPETA001
                 END-IF
              END-IF
           END-IF
           .
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE CREATEDDATE OF DCLTBPET001 TO
                   CREATEDDATE OF W-LPETA001
              MOVE UPDATEDDATE OF DCLTBPET001 TO
                   UPDATEDDATE OF W-LPETA001
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'11' TO REASONCODE OF W-LPETA001
              MOVE N'TBPET001 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA001 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'12' TO REASONCODE OF W-LPETA001
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA001
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE TABLEID OF W-LPETA001 TO TABLEID OF DCLTBPET001
           MOVE TABKEY OF W-LPETA001 TO TABKEY OF DCLTBPET001
           ...
           WHEN 0
              IF TABVALUE-IND OF DCLTBPET001 < 0
                 MOVE LOW-VALUES TO TABVALUE OF W-LPETA001
              ELSE
                 MOVE TABVALUE OF DCLTBPET001 TO
                      TABVALUE OF W-LPETA001
              END-IF
              ...
              MOVE UPDATEDDATE OF DCLTBPET001 TO
                   UPDATEDDATE OF W-LPETA001
           WHEN 100
              MOVE N'04' TO RETURNCODE OF W-LPETA001
              MOVE N'01' TO REASONCODE OF W-LPETA001
              MOVE N'TBPET001 entry not found' TO
                   INFOMESSAGE OF W-LPETA001 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'21' TO REASONCODE OF W-LPETA001
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'31' TO REASONCODE OF W-LPETA001
              MOVE N'TBPET001 entry not found' TO
                   INFOMESSAGE OF W-LPETA001 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'32' TO REASONCODE OF W-LPETA001
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'41' TO REASONCODE OF W-LPETA001
              MOVE N'TBPET001 entry not found' TO
                   INFOMESSAGE OF W-LPETA001 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA001
              MOVE N'42' TO REASONCODE OF W-LPETA001
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE TABLEID OF W-LPETA001 TO TABLEID OF DCLTBPET001
           MOVE TABKEY  OF W-LPETA001 TO TABKEY  OF DCLTBPET001
           IF TABVALUE OF W-LPETA001 = LOW-VALUES
              MOVE -1 TO TABVALUE-IND OF DCLTBPET001
              MOVE LOW-VALUES TO TABVALUE OF DCLTBPET001
           ELSE
              MOVE 0 TO TABVALUE-IND OF DCLTBPET001
              MOVE TABVALUE  OF W-LPETA001 TO TABVALUE OF DCLTBPET001
           END-IF
           MOVE CREATEDBY OF W-LPETA001 TO CREATEDBY OF DCLTBPET001
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETA001) TO
              CREATEDDATE OF DCLTBPET001
           MOVE UPDATEDBY OF W-LPETA001 TO UPDATEDBY OF DCLTBPET001
