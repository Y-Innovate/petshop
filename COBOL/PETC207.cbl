      ...
      *===============================================================*
       R001-INIT SECTION.
           ...
           IF SW-CONT-FOUND
              ...
              MOVE P-CHAR(1:W-CONT-LENGTH) TO W-LPETM207
           END-IF
      ...
      *===============================================================*
      * R005-CALL-PETM207: Call PETM207                               *
      *===============================================================*
       R005-CALL-PETM207 SECTION.
           MOVE 'PETM207' TO W-PGMNAME

           CALL W-PGMNAME USING W-LPETM207

           IF RETURNCODE OF W-LPETM207 NOT = N'00'
              IF RETURNCODE OF W-LPETM207 = N'04'
      ...
      *===============================================================*
       R009-FINISH SECTION.
           MOVE C-CHNL-NAME-LWW      TO W-CHNL-NAME 
           MOVE C-CONT-NAME-LWW-03   TO W-CONT-NAME
           MOVE LENGTH OF W-LPETM207 TO W-CONT-LENGTH
           SET W-CONT-POINTER TO ADDRESS OF W-LPETM207
