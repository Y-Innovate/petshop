      ...
      *===============================================================*
       R001-INIT SECTION.
           ...
           IF SW-CONT-FOUND
              ...
              MOVE P-CHAR(1:W-CONT-LENGTH) TO W-LPETM205
           END-IF
      ...
      *===============================================================*
      * R005-CALL-PETM205: Call PETM205                               *
      *===============================================================*
       R005-CALL-PETM205 SECTION.
           MOVE 'PETM205' TO W-PGMNAME

           CALL W-PGMNAME USING W-LPETM205

           IF RETURNCODE OF W-LPETM205 NOT = N'00'
              IF RETURNCODE OF W-LPETM205 = N'04'
      ...
      *===============================================================*
       R009-FINISH SECTION.
           MOVE C-CHNL-NAME-LWW      TO W-CHNL-NAME 
           MOVE C-CONT-NAME-LWW-03   TO W-CONT-NAME
           MOVE LENGTH OF W-LPETM205 TO W-CONT-LENGTH
           SET W-CONT-POINTER TO ADDRESS OF W-LPETM205
