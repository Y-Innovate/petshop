      ...
      *===============================================================*
       ...
       R210-CHECK-INPUT SECTION.
           ...
           OR ACTIONI OF W-PETB06I = 'U'
              ...
              IF SW-INPUT-OK
                 ...
                 MOVE N'ANMLTYPE' TO TABLEID OF W-LPETA001
              ...
              IF SW-INPUT-OK
                 INITIALIZE W-LPETA001
                 MOVE N'R' TO OPCODE OF W-LPETA001
                 MOVE N'ANMLRACE' TO TABLEID OF W-LPETA001
       ...
       R320-PERFORM-ACTION SECTION.
           ...
           IF OPCODE OF W-LPETA001 NOT = N'D'
              ...
              MOVE W-STOREID TO STOREID OF W-LPETA006
              MOVE FUNCTION NATIONAL-OF(ANIMLTPI OF W-PETB06I) TO
                   ANIMALTYPE OF W-LPETA006
              MOVE FUNCTION NATIONAL-OF(ANIMLRCI OF W-PETB06I) TO
                   ANIMALRACE OF W-LPETA006
              MOVE ANIMLNML OF W-PETB06I TO ANIMALNAME-LEN OF W-LPETA006
              MOVE FUNCTION NATIONAL-OF(ANIMLNMI OF W-PETB06I) TO
                   ANIMALNAME-TEXT OF W-LPETA006
           END-IF

           IF OPCODE OF W-LPETA006 = N'C'
           OR OPCODE OF W-LPETA006 = N'U'
              MOVE ANIMLGEI OF W-PETB06I TO ANIMALGENDER OF W-LPETA006
              MOVE ANIMLAGI OF W-PETB06I TO W-ANIMALAGE
              MOVE W-ANIMALAGE TO ANIMALAGE OF W-LPETA006
              MOVE ANIMLCOI OF W-PETB06I TO W-ANIMALCOUNT
              MOVE W-ANIMALCOUNT TO ANIMALCOUNT OF W-LPETA006
           END-IF
           ...
           MOVE FUNCTION DISPLAY-OF(INFOMESSAGE OF W-LPETA006) TO
                ERRMSGO OF W-PETB06O
           
           IF  RETURNCODE OF W-LPETA006 = N'00'
              IF OPCODE OF W-LPETA006 NOT = N'D'
                 MOVE ANIMALID OF W-LPETA006 TO W-ANIMALID
                 MOVE W-ANIMALID TO ANIMLIDI OF W-PETB06I
                 MOVE 8          TO ANIMLIDL OF W-PETB06I
                 MOVE STOREID OF W-LPETA006 TO W-STOREID
                 MOVE W-STOREID TO STOREIDI OF W-PETB06I
                 MOVE 8         TO STOREIDL OF W-PETB06I
                 MOVE FUNCTION DISPLAY-OF(ANIMALTYPE OF W-LPETA006) TO
                      ANIMLTPI OF W-PETB06I
                 MOVE 8 TO ANIMLTPL OF W-PETB06I
                 MOVE FUNCTION DISPLAY-OF(ANIMALRACE OF W-LPETA006)
                      TO ANIMLRCI OF W-PETB06I
                 MOVE 8 TO ANIMLRCL OF W-PETB06I
                 MOVE FUNCTION DISPLAY-OF(
                         ANIMALNAME-TEXT OF W-LPETA006(1:
                            ANIMALNAME-LEN OF W-LPETA006)) TO
                      ANIMLNMI OF W-PETB06I
                 IF ANIMALNAME-LEN OF W-LPETA006 >= 60
                    MOVE 60 TO ANIMLNML OF W-PETB06I
                 ELSE
                    MOVE ANIMALNAME-LEN OF W-LPETA006 TO
                         ANIMLNML OF W-PETB06I
                 END-IF
                 MOVE FUNCTION DISPLAY-OF(ANIMALGENDER OF W-LPETA006) TO
                      ANIMLGEI OF W-PETB06I
                 MOVE 1 TO ANIMLGEL OF W-PETB06I
                 MOVE ANIMALAGE OF W-LPETA006 TO W-ANIMALAGE
                 MOVE W-ANIMALAGE TO ANIMLAGI OF W-PETB06I
                 MOVE 8           TO ANIMLAGL OF W-PETB06I
                 MOVE ANIMALCOUNT OF W-LPETA006 TO W-ANIMALCOUNT
                 MOVE W-ANIMALCOUNT TO ANIMLCOI OF W-PETB06I
                 MOVE 8             TO ANIMLCOL OF W-PETB06I
                 MOVE FUNCTION DISPLAY-OF(CREATEDBY OF W-LPETA006) TO
                      CREBYI OF W-PETB06I
                 ...
                 MOVE FUNCTION DISPLAY-OF(UPDATEDBY OF W-LPETA006) TO
                      UPDBYI OF W-PETB06I
