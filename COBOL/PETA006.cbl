      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA006.
       MAIN SECTION.
           PERFORM R001-INIT

           PERFORM R002-CHECKPARM

           IF RETURNCODE OF W-LPETA006 = N'00'
              EVALUATE OPCODE OF W-LPETA006
              WHEN N'C'
                 PERFORM R110-INSERT
              WHEN N'R'
                 PERFORM R120-SELECT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA006 TO W-LPETA006

           MOVE N'00' TO RETURNCODE OF W-LPETA006
           MOVE N'00' TO REASONCODE OF W-LPETA006
           MOVE SPACES TO INFOMESSAGE OF W-LPETA006
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA006 NOT = N'C'
           AND OPCODE OF W-LPETA006 NOT = N'R'
           AND OPCODE OF W-LPETA006 NOT = N'U'
           AND OPCODE OF W-LPETA006 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA006
              MOVE N'01' TO REASONCODE OF W-LPETA006
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA006
           END-IF

           IF  OPCODE OF W-LPETA006 NOT = N'C'
           AND OPCODE OF W-LPETA006 NOT = N'R'
              IF  RETURNCODE OF W-LPETA006 = N'00'
              AND ANIMALID OF W-LPETA006 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA006
                 MOVE N'02' TO REASONCODE OF W-LPETA006
                 MOVE N'ANIMALID is required' TO
                      INFOMESSAGE OF W-LPETA006
              END-IF
           END-IF

           IF   OPCODE OF W-LPETA006 = N'R'
              IF   ANIMALID OF W-LPETA006 = 0
              AND (STOREID  OF W-LPETA006 = 0
              OR   ANIMALTYPE OF W-LPETA006 = SPACES
              OR   ANIMALTYPE OF W-LPETA006 = LOW-VALUES
              OR   ANIMALRACE OF W-LPETA006 = SPACES
              OR   ANIMALRACE OF W-LPETA006 = LOW-VALUES
              OR   ANIMALNAME-LEN OF W-LPETA006 = 0
              OR   ANIMALNAME-TEXT OF W-LPETA006(1:
                      ANIMALNAME-LEN OF W-LPETA006) = SPACES
              OR   ANIMALNAME-TEXT OF W-LPETA006(1:
                      ANIMALNAME-LEN OF W-LPETA006) = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA006
                 MOVE N'03' TO REASONCODE OF W-LPETA006
                 MOVE N'STOREID is required' TO
                      INFOMESSAGE OF W-LPETA006
              END-IF
           END-IF

           IF OPCODE OF W-LPETA006 = N'C'
           OR OPCODE OF W-LPETA006 = N'U'
              IF  RETURNCODE OF W-LPETA006 = N'00'
              AND STOREID OF W-LPETA006 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA006
                 MOVE N'03' TO REASONCODE OF W-LPETA006
              ...
              IF  RETURNCODE OF W-LPETA006 = N'00'
              AND ANIMALTYPE OF W-LPETA006 = SPACES
                 MOVE N'08' TO RETURNCODE OF W-LPETA006
                 MOVE N'04' TO REASONCODE OF W-LPETA006
                 MOVE N'ANIMALTYPE is required' TO
                      INFOMESSAGE OF W-LPETA006
              END-IF

              IF  RETURNCODE OF W-LPETA006 = N'00'
              AND ANIMALRACE OF W-LPETA006 = SPACES
                 MOVE N'08' TO RETURNCODE OF W-LPETA006
                 MOVE N'05' TO REASONCODE OF W-LPETA006
                 MOVE N'ANIMALRACE is required' TO
                      INFOMESSAGE OF W-LPETA006
              END-IF

              IF  RETURNCODE OF W-LPETA006 = N'00'
              AND ANIMALCOUNT OF W-LPETA006 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA006
                 MOVE N'06' TO REASONCODE OF W-LPETA006
                 MOVE N'ANIMALCOUNT is required' TO
                      INFOMESSAGE OF W-LPETA006
              END-IF

              IF CREATEDBY OF W-LPETA006 = SPACES
              OR CREATEDBY OF W-LPETA006 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA006 = SPACES
              OR UPDATEDBY OF W-LPETA006 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA006 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA006
                    END-IF

                    IF UPDATEDBY OF W-LPETA006 = SPACES
                    OR UPDATEDBY OF W-LPETA006 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA006
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA006
                    MOVE N'90' TO REASONCODE OF W-LPETA006
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE ANIMALID OF DCLTBPET006 TO
                   ANIMALID OF W-LPETA006
              MOVE CREATEDDATE OF DCLTBPET006 TO
                   CREATEDDATE OF W-LPETA006
              MOVE UPDATEDDATE OF DCLTBPET006 TO
                   UPDATEDDATE OF W-LPETA006
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA006
              MOVE N'11' TO REASONCODE OF W-LPETA006
              MOVE N'TBPET006 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA006
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA006
              MOVE N'12' TO REASONCODE OF W-LPETA006
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA006
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE ANIMALID   OF W-LPETA006 TO ANIMALID OF DCLTBPET006
           MOVE STOREID    OF W-LPETA006 TO STOREID  OF DCLTBPET006
           MOVE ANIMALTYPE OF W-LPETA006 TO ANIMALTYPE OF DCLTBPET006
           MOVE ANIMALRACE OF W-LPETA006 TO ANIMALRACE OF DCLTBPET006
           MOVE ANIMALNAME OF W-LPETA006 TO ANIMALNAME OF DCLTBPET006
           ...
           WHEN 0
              ...
              MOVE UPDATEDDATE  OF DCLTBPET006 TO
                   UPDATEDDATE  OF W-LPETA006
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETA006
                MOVE N'01' TO REASONCODE OF W-LPETA006
                MOVE N'TBPET006 entry not found' TO
                   INFOMESSAGE OF W-LPETA006
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETA006
                MOVE N'21' TO REASONCODE OF W-LPETA006
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA006
              MOVE N'31' TO REASONCODE OF W-LPETA006
              MOVE N'TBPET006 entry not found' TO
                   INFOMESSAGE OF W-LPETA006 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA006
              MOVE N'32' TO REASONCODE OF W-LPETA006
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA006
              MOVE N'41' TO REASONCODE OF W-LPETA006
              MOVE N'TBPET006 entry not found' TO
                   INFOMESSAGE OF W-LPETA006
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA006
              MOVE N'42' TO REASONCODE OF W-LPETA006
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           ...
           MOVE ANIMALRACE   OF W-LPETA006 TO ANIMALRACE  OF DCLTBPET006
           MOVE ANIMALNAME   OF W-LPETA006 TO ANIMALNAME  OF DCLTBPET006
           MOVE ANIMALGENDER OF W-LPETA006 TO
                ANIMALGENDER OF DCLTBPET006
           MOVE ANIMALAGE    OF W-LPETA006 TO ANIMALAGE   OF DCLTBPET006
           MOVE ANIMALCOUNT  OF W-LPETA006 TO ANIMALCOUNT OF DCLTBPET006
           MOVE CREATEDBY    OF W-LPETA006 TO CREATEDBY   OF DCLTBPET006
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETA006) TO
              CREATEDDATE OF DCLTBPET006
           MOVE UPDATEDBY    OF W-LPETA006 TO UPDATEDBY   OF DCLTBPET006
           MOVE FUNCTION DISPLAY-OF(UPDATEDDATE OF W-LPETA006) TO
