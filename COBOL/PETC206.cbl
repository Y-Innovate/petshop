      ...
      *===============================================================*
       R001-INIT SECTION.
           ...
           IF SW-CONT-FOUND
              ...
              MOVE P-CHAR(1:W-CONT-LENGTH) TO W-LPETM206
           END-IF
      ...
      *===============================================================*
      * R005-CALL-PETM206: Call PETM206                               *
      *===============================================================*
       R005-CALL-PETM206 SECTION.
           MOVE 'PETM206' TO W-PGMNAME

           CALL W-PGMNAME USING W-LPETM206

           IF RETURNCODE OF W-LPETM206 NOT = N'00'
              IF RETURNCODE OF W-LPETM206 = N'04'
      ...
      *===============================================================*
       R009-FINISH SECTION.
           MOVE C-CHNL-NAME-LWW      TO W-CHNL-NAME 
           MOVE C-CONT-NAME-LWW-03   TO W-CONT-NAME
           MOVE LENGTH OF W-LPETM206 TO W-CONT-LENGTH
           SET W-CONT-POINTER TO ADDRESS OF W-LPETM206
