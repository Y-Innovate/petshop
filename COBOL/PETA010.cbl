      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA010.
       MAIN SECTION.
           PERFORM R001-INIT

           PERFORM R002-CHECKPARM

           IF RETURNCODE OF W-LPETA010 = N'00'
              EVALUATE OPCODE OF W-LPETA010
              WHEN N'C'
                 PERFORM R110-INSERT
              WHEN N'R'
                 PERFORM R120-SELECT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA010 TO W-LPETA010

           MOVE N'00' TO RETURNCODE OF W-LPETA010
           MOVE N'00' TO REASONCODE OF W-LPETA010
           MOVE SPACES TO INFOMESSAGE OF W-LPETA010
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA010 NOT = N'C'
           AND OPCODE OF W-LPETA010 NOT = N'R'
           AND OPCODE OF W-LPETA010 NOT = N'U'
           AND OPCODE OF W-LPETA010 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA010
              MOVE N'01' TO REASONCODE OF W-LPETA010
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA010
           END-IF

           IF OPCODE OF W-LPETA010 NOT = N'C'
              IF  RETURNCODE OF W-LPETA010 = N'00'
              AND ORDERID    OF W-LPETA010 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA010
                 MOVE N'02' TO REASONCODE OF W-LPETA010
                 MOVE N'ORDERID is required' TO
                      INFOMESSAGE OF W-LPETA010
              END-IF
           END-IF

           IF OPCODE OF W-LPETA010 = N'C'
           OR OPCODE OF W-LPETA010 = N'U'
              IF  RETURNCODE OF W-LPETA010 = N'00'
              AND STOREID    OF W-LPETA010 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA010
                 MOVE N'03' TO REASONCODE OF W-LPETA010
                 MOVE N'STOREID is required' TO
                      INFOMESSAGE OF W-LPETA010
              END-IF

              IF  RETURNCODE OF W-LPETA010 = N'00'
              AND PURCHASEID OF W-LPETA010 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA010
                 MOVE N'04' TO REASONCODE OF W-LPETA010
                 MOVE N'PURCHASEID is required' TO
                      INFOMESSAGE OF W-LPETA010
              END-IF

              IF   RETURNCODE OF W-LPETA010 = N'00'
              AND (ORDERDATE  OF W-LPETA010 = SPACES
              OR   ORDERDATE  OF W-LPETA010 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA010
                 MOVE N'05' TO REASONCODE OF W-LPETA010
                 MOVE N'ORDERDATE is required' TO
                      INFOMESSAGE OF W-LPETA010
              END-IF

              IF  RETURNCODE OF W-LPETA010 = N'00'
              AND PRODUCTID  OF W-LPETA010 = 0
              AND ANIMALID   OF W-LPETA010 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA010
                 MOVE N'06' TO REASONCODE OF W-LPETA010
                 MOVE N'PRODUCTID or ANIMALID is required' TO
                      INFOMESSAGE OF W-LPETA010
              END-IF

              IF  RETURNCODE OF W-LPETA010 = N'00'
              AND ORDERCOUNT OF W-LPETA010 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA010
                 MOVE N'07' TO REASONCODE OF W-LPETA010
                 MOVE N'ORDERCOUNT is required' TO
                      INFOMESSAGE OF W-LPETA010
              END-IF

              IF  RETURNCODE OF W-LPETA010 = N'00'
              AND PRICE      OF W-LPETA010 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA010
                 MOVE N'08' TO REASONCODE OF W-LPETA010
                 MOVE N'PRICE is required' TO
                      INFOMESSAGE OF W-LPETA010
              END-IF

              IF CREATEDBY OF W-LPETA010 = SPACES
              OR CREATEDBY OF W-LPETA010 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA010 = SPACES
              OR UPDATEDBY OF W-LPETA010 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA010 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA010
                    END-IF

                    IF UPDATEDBY OF W-LPETA010 = SPACES
                    OR UPDATEDBY OF W-LPETA010 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA010
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA010
                    MOVE N'90' TO REASONCODE OF W-LPETA010
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE ORDERID     OF DCLTBPET010 TO
                   ORDERID     OF W-LPETA010
              MOVE CREATEDDATE OF DCLTBPET010 TO
                   CREATEDDATE OF W-LPETA010
              MOVE UPDATEDDATE OF DCLTBPET010 TO
                   UPDATEDDATE OF W-LPETA010
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA010
              MOVE N'11' TO REASONCODE OF W-LPETA010
              MOVE N'TBPET010 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA010
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA010
              MOVE N'12' TO REASONCODE OF W-LPETA010
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA010
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE ORDERID OF W-LPETA010 TO ORDERID OF DCLTBPET010
           ...
           EVALUATE SQLCODE
           WHEN 0
              MOVE STOREID    OF DCLTBPET010 TO STOREID    OF W-LPETA010
              MOVE PURCHASEID OF DCLTBPET010 TO PURCHASEID OF W-LPETA010
              MOVE ORDERDATE  OF DCLTBPET010 TO ORDERDATE  OF W-LPETA010
              IF PRODUCTID-IND OF DCLTBPET010 < 0
                 MOVE 0 TO PRODUCTID OF W-LPETA010
              ELSE
                 MOVE PRODUCTID OF DCLTBPET010 TO
                      PRODUCTID OF W-LPETA010
              END-IF
              IF ANIMALID-IND OF DCLTBPET010 < 0
                 MOVE 0 TO ANIMALID OF W-LPETA010
              ELSE
                 MOVE ANIMALID OF DCLTBPET010 TO ANIMALID OF W-LPETA010
              END-IF
              MOVE ORDERCOUNT     OF DCLTBPET010 TO
                   ORDERCOUNT     OF W-LPETA010
              MOVE TYPEOFDISCOUNT OF DCLTBPET010 TO
                   TYPEOFDISCOUNT OF W-LPETA010
              MOVE PRICE          OF DCLTBPET010 TO
                   PRICE          OF W-LPETA010
              IF DISCOUNT-IND OF DCLTBPET010 < 0
                 MOVE 0 TO DISCOUNT OF W-LPETA010
              ELSE
                 MOVE DISCOUNT OF DCLTBPET010 TO DISCOUNT OF W-LPETA010
              END-IF
              ...
              MOVE UPDATEDDATE OF DCLTBPET010 TO
                   UPDATEDDATE OF W-LPETA010
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETA010
                MOVE N'01' TO REASONCODE OF W-LPETA010
                MOVE N'TBPET010 entry not found' TO
                   INFOMESSAGE OF W-LPETA010
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETA010
                MOVE N'21' TO REASONCODE OF W-LPETA010
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA010
              MOVE N'31' TO REASONCODE OF W-LPETA010
              MOVE N'TBPET010 entry not found' TO
                   INFOMESSAGE OF W-LPETA010 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA010
              MOVE N'32' TO REASONCODE OF W-LPETA010
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA010
              MOVE N'41' TO REASONCODE OF W-LPETA010
              MOVE N'TBPET010 entry not found' TO
                   INFOMESSAGE OF W-LPETA010
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA010
              MOVE N'42' TO REASONCODE OF W-LPETA010
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE STOREID    OF W-LPETA010 TO STOREID    OF DCLTBPET010
           MOVE PURCHASEID OF W-LPETA010 TO PURCHASEID OF DCLTBPET010
           MOVE FUNCTION DISPLAY-OF(ORDERDATE OF W-LPETA010) TO
                ORDERDATE OF DCLTBPET010
           IF PRODUCTID OF W-LPETA010 = 0
              MOVE -1 TO PRODUCTID-IND OF DCLTBPET010
              MOVE 0 TO PRODUCTID OF DCLTBPET010
           ELSE
              MOVE 0 TO PRODUCTID-IND OF DCLTBPET010
              MOVE PRODUCTID OF W-LPETA010 TO PRODUCTID OF DCLTBPET010
           END-IF
           IF ANIMALID OF W-LPETA010 = 0
              MOVE -1 TO ANIMALID-IND OF DCLTBPET010
              MOVE 0 TO ANIMALID OF DCLTBPET010
           ELSE
              MOVE 0 TO ANIMALID-IND OF DCLTBPET010
              MOVE ANIMALID OF W-LPETA010 TO ANIMALID OF DCLTBPET010
           END-IF
           MOVE ORDERCOUNT     OF W-LPETA010 TO
                ORDERCOUNT     OF DCLTBPET010 
           MOVE TYPEOFDISCOUNT OF W-LPETA010 TO
                TYPEOFDISCOUNT OF DCLTBPET010
           MOVE PRICE          OF W-LPETA010 TO
                PRICE          OF DCLTBPET010
           IF DISCOUNT OF W-LPETA010 = 0
              MOVE -1 TO DISCOUNT-IND OF DCLTBPET010
              MOVE 0 TO DISCOUNT OF DCLTBPET010
           ELSE
              MOVE 0 TO DISCOUNT-IND OF DCLTBPET010
              MOVE DISCOUNT OF W-LPETA010 TO DISCOUNT OF DCLTBPET010
           END-IF
           MOVE CREATEDBY    OF W-LPETA010 TO CREATEDBY   OF DCLTBPET010
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETA010) TO
              CREATEDDATE OF DCLTBPET010
           MOVE UPDATEDBY    OF W-LPETA010 TO UPDATEDBY   OF DCLTBPET010
           MOVE FUNCTION DISPLAY-OF(UPDATEDDATE OF W-LPETA010) TO
