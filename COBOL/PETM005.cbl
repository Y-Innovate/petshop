      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETM005.
       MAIN SECTION.
           PERFORM R001-INIT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETM005 TO W-LPETM005

           MOVE N'00' TO RETURNCODE OF W-LPETM005
           MOVE N'00' TO REASONCODE OF W-LPETM005
           MOVE SPACES TO INFOMESSAGE OF W-LPETM005
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETM005 NOT = N'C'
           AND OPCODE OF W-LPETM005 NOT = N'R'
           AND OPCODE OF W-LPETM005 NOT = N'U'
           AND OPCODE OF W-LPETM005 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETM005
              MOVE N'01' TO REASONCODE OF W-LPETM005
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETM005
           END-IF

           IF  OPCODE OF W-LPETM005 NOT = N'C'
           AND OPCODE OF W-LPETM005 NOT = N'R'
              IF  RETURNCODE OF W-LPETM005 = N'00'
              AND INVENTORYID OF W-LPETM005 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM005
                 MOVE N'02' TO REASONCODE OF W-LPETM005
                 MOVE N'INVENTORYID is required' TO
                      INFOMESSAGE OF W-LPETM005
              END-IF
           END-IF

           IF OPCODE OF W-LPETM005 = N'R'
              IF  INVENTORYID OF W-LPETM005 = 0
              AND (STOREID OF W-LPETM005 = 0
              OR   PRODUCTID OF W-LPETM005 = 0
              OR   SELLBYDATE OF W-LPETM005 = SPACES
              OR   SELLBYDATE OF W-LPETM005 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETM005
                 MOVE N'03' TO REASONCODE OF W-LPETM005
                 MOVE N'STOREID is required' TO
                      INFOMESSAGE OF W-LPETM005
              END-IF
           END-IF

           IF OPCODE OF W-LPETM005 = N'C'
           OR OPCODE OF W-LPETM005 = N'U'
              IF  RETURNCODE OF W-LPETM005 = N'00'
              AND STOREID OF W-LPETM005 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM005
                 MOVE N'03' TO REASONCODE OF W-LPETM005
              ...
              IF  RETURNCODE OF W-LPETM005 = N'00'
              AND PRODUCTID OF W-LPETM005 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM005
                 MOVE N'04' TO REASONCODE OF W-LPETM005
                 MOVE N'PRODUCTID is required' TO
                      INFOMESSAGE OF W-LPETM005
              END-IF

              IF   RETURNCODE OF W-LPETM005 = N'00'
              AND (SELLBYDATE OF W-LPETM005 = SPACES
              OR   SELLBYDATE OF W-LPETM005 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETM005
                 MOVE N'05' TO REASONCODE OF W-LPETM005
                 MOVE N'SELLBYDATE is required' TO
                      INFOMESSAGE OF W-LPETM005
              END-IF

              IF  RETURNCODE OF W-LPETM005 = N'00'
              AND INSTOCK OF W-LPETM005 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM005
                 MOVE N'06' TO REASONCODE OF W-LPETM005
                 MOVE N'INSTOCK is required' TO
                      INFOMESSAGE OF W-LPETM005
              END-IF

              IF CREATEDBY OF W-LPETM005 = SPACES
              OR CREATEDBY OF W-LPETM005 = LOW-VALUES
              OR UPDATEDBY OF W-LPETM005 = SPACES
              OR UPDATEDBY OF W-LPETM005 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA990 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETM005 = LOW-VALUES
                       MOVE USERID OF W-LPETA990 TO
                            CREATEDBY OF W-LPETM005
                    END-IF

                    IF UPDATEDBY OF W-LPETM005 = SPACES
                    OR UPDATEDBY OF W-LPETM005 = LOW-VALUES
                       MOVE USERID OF W-LPETA990 TO
                            UPDATEDBY OF W-LPETM005
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETM005
                    MOVE N'90' TO REASONCODE OF W-LPETM005
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE INVENTORYID OF DCLTBPET005 TO
                   INVENTORYID OF W-LPETM005
              MOVE CREATEDDATE OF DCLTBPET005 TO
                   CREATEDDATE OF W-LPETM005
              MOVE UPDATEDDATE OF DCLTBPET005 TO
                   UPDATEDDATE OF W-LPETM005
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETM005
           ...
           WHEN OTHER
              ...
              STRING N'INSERT gave SQLCODE='
                 ...
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETM005
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE INVENTORYID OF W-LPETM005 TO INVENTORYID OF DCLTBPET005
           MOVE STOREID     OF W-LPETM005 TO STOREID     OF DCLTBPET005
           MOVE PRODUCTID   OF W-LPETM005 TO PRODUCTID   OF DCLTBPET005
           ...
           WHEN 0
              ...
              MOVE UPDATEDDATE OF DCLTBPET005 TO
                   UPDATEDDATE OF W-LPETM005
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETM005
                MOVE N'01' TO REASONCODE OF W-LPETM005
                MOVE N'TBPET005 entry not found' TO
                   INFOMESSAGE OF W-LPETM005
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETM005
                MOVE N'21' TO REASONCODE OF W-LPETM005
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETM005
              MOVE N'32' TO REASONCODE OF W-LPETM005
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETM005
              MOVE N'41' TO REASONCODE OF W-LPETM005
              MOVE N'TBPET005 entry not found' TO
                   INFOMESSAGE OF W-LPETM005
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETM005
              MOVE N'42' TO REASONCODE OF W-LPETM005
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           ...
           MOVE FUNCTION DISPLAY-OF(SELLBYDATE OF W-LPETM005) TO
                SELLBYDATE  OF DCLTBPET005
           MOVE INSTOCK     OF W-LPETM005 TO INSTOCK     OF DCLTBPET005
           MOVE CREATEDBY   OF W-LPETM005 TO CREATEDBY   OF DCLTBPET005
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETM005) TO
              CREATEDDATE OF DCLTBPET005
           MOVE UPDATEDBY   OF W-LPETM005 TO UPDATEDBY   OF DCLTBPET005
