      ...
      * emergency transaction to manipulate SUPPLIERS records.        *
      * ------------------------------------------------------------- *
      * Updates:                                                      *
      *                                                               *
      * Date     Who What                                             *
      ...
      *===============================================================*
       ...
       01  WORK.
           ...
           05  C-CONT-NAME-B03       PIC X(16) VALUE 'BMS-PETB03'.
       ...
       COPY PETB03.
       COPY PETB03 REPLACING ==PETB03I== BY ==W-PETB03I==
                             ==PETB03O== BY ==W-PETB03O==.
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE LOW-VALUES TO PETB03I
           MOVE LOW-VALUES TO W-PETB03I
           ...
           IF CURRENT-SCREEN OF W-LPETC900 = '03'
              SET SW-DO-INPUT-PROCESSING TO TRUE
           ELSE
              SET SW-SKIP-INPUT-PROCESSING TO TRUE
              MOVE '03' TO CURRENT-SCREEN OF W-LPETC900
           END-IF
           SET SW-DO-OUTPUT-PROCESSING TO TRUE

           MOVE C-CONT-NAME-B03 TO W-CONT-NAME

           PERFORM R910-GET-CONTAINER

           IF SW-CONT-FOUND
              SET ADDRESS OF P-CHAR TO W-CONT-POINTER
              MOVE P-CHAR(1:W-CONT-LENGTH) TO W-PETB03I

              IF SW-SKIP-INPUT-PROCESSING
                 MOVE '_' TO ACTIONI OF W-PETB03I
                 MOVE SPACES TO ERRMSGO OF W-PETB03O
              END-IF
           END-IF
      ...
      *===============================================================*
       ...
       R110-INPUT-PROC SECTION.
           EXEC CICS
              RECEIVE MAP('PETB03') MAPSET('PETB03')
                      INTO(PETB03I) NOHANDLE
           END-EXEC
           ...
           ELSE
              ...
              STRING 'RECEIVE MAP ERROR PETB03 ' W-EIBRESP ' '
                     W-EIBRESP2
                     DELIMITED BY SIZE
                INTO Vstring-text
       ...
       R120-OUTPUT-PROC SECTION.
           ...
           MOVE W-APPLID         TO APPLIDO OF W-PETB03O
           STRING W-COBOL-DAY '-' W-COBOL-MONTH '-' W-COBOL-YEAR
                  DELIMITED BY SIZE
             INTO TODAYO OF W-PETB03O
           MOVE EIBTRNID         TO TRNIDO  OF W-PETB03O
           MOVE EIBTRMID         TO TRMIDO  OF W-PETB03O
           MOVE W-CURRDATE(12:8) TO NOWO    OF W-PETB03O

           IF SW-SKIP-INPUT-PROCESSING
              MOVE C-ATTR-UNPROT-MDT TO SUPPLCDF OF W-PETB03I
              MOVE -1 TO SUPPLCDL OF W-PETB03I
           END-IF

           MOVE W-PETB03I TO PETB03I

           EXEC CICS
              SEND MAP('PETB03') MAPSET('PETB03')
                   FROM(PETB03O) FREEKB ERASE CURSOR NOHANDLE
           END-EXEC

           IF EIBRESP = DFHRESP(NORMAL)
              MOVE C-CONT-NAME-B03 TO W-CONT-NAME
              MOVE LENGTH OF W-PETB03I TO W-CONT-LENGTH
              SET W-CONT-POINTER TO ADDRESS OF W-PETB03I
           ...
           ELSE
              ...
              MOVE EIBRESP2 TO W-EIBRESP2
              MOVE 1 TO Vstring-length
              STRING 'SEND MAP ERROR PETB03 ' W-EIBRESP ' '
                     W-EIBRESP2
                     DELIMITED BY SIZE
                INTO Vstring-text
                WITH POINTER Vstring-length
       ...
       R210-CHECK-INPUT SECTION.
           ...
           IF   ACTIONL OF W-PETB03I = 0
           OR  (ACTIONI OF W-PETB03I NOT = 'C'
           AND  ACTIONI OF W-PETB03I NOT = 'R'
           AND  ACTIONI OF W-PETB03I NOT = 'U'
           AND  ACTIONI OF W-PETB03I NOT = 'D')
              MOVE C-ATTR-UNPROT-BRT-MDT TO ACTIONF OF W-PETB03I
              MOVE -1 TO ACTIONL OF W-PETB03I
              MOVE 'INVALID ACTION' TO ERRMSGO OF W-PETB03O
              SET SW-INPUT-ERROR TO TRUE
           END-IF

           IF SUPPLCDL OF W-PETB03I = 0
           OR SUPPLCDI OF W-PETB03I = SPACES
              MOVE C-ATTR-UNPROT-BRT-MDT TO SUPPLCDF OF W-PETB03I
              IF SW-INPUT-OK
                 MOVE -1 TO SUPPLCDL OF W-PETB03I
                 MOVE 'INVALID SUPPLIERCODE' TO ERRMSGO OF W-PETB03O
                 SET SW-INPUT-ERROR TO TRUE
              END-IF
           END-IF

           IF ACTIONI OF W-PETB03I = 'C'
           OR ACTIONI OF W-PETB03I = 'U'
              IF SUPPLSTL OF W-PETB03I = 0
              OR SUPPLSTI OF W-PETB03I = SPACES
                 MOVE C-ATTR-UNPROT-BRT-MDT TO SUPPLSTF OF W-PETB03I
                 IF SW-INPUT-OK
                    MOVE -1 TO SUPPLSTL OF W-PETB03I
                    MOVE 'INVALID SUPPLIERSTATUS' TO
       ...
       R310-PROCESS-BMS SECTION.
           IF SUPPLCDL OF PETB03I NOT = 0
           OR SUPPLCDF OF PETB03I > X'80'
              MOVE SUPPLCDL OF PETB03I TO SUPPLCDL OF W-PETB03I
              MOVE SUPPLCDF OF PETB03I TO SUPPLCDF OF W-PETB03I
              MOVE FUNCTION UPPER-CASE(SUPPLCDI OF PETB03I) TO
                   SUPPLCDI OF W-PETB03I
           END-IF

           IF SUPPLSTL OF PETB03I NOT = 0
           OR SUPPLSTF OF PETB03I > X'80'
              MOVE SUPPLSTL OF PETB03I TO SUPPLSTL OF W-PETB03I
              MOVE SUPPLSTF OF PETB03I TO SUPPLSTF OF W-PETB03I
              MOVE FUNCTION UPPER-CASE(SUPPLSTI OF PETB03I) TO
                   SUPPLSTI OF W-PETB03I
           END-IF

           IF SUPPLNML OF PETB03I NOT = 0
           OR SUPPLNMF OF PETB03I > X'80'
              MOVE SUPPLNML OF PETB03I TO SUPPLNML OF W-PETB03I
              MOVE SUPPLNMF OF PETB03I TO SUPPLNMF OF W-PETB03I
              MOVE SUPPLNMI OF PETB03I TO SUPPLNMI OF W-PETB03I
           END-IF

           IF ACTIONL OF PETB03I NOT = 0
           OR ACTIONF OF PETB03I > X'80'
              MOVE ACTIONL OF PETB03I TO ACTIONL OF W-PETB03I
              MOVE ACTIONF OF PETB03I TO ACTIONF OF W-PETB03I
              MOVE FUNCTION UPPER-CASE(ACTIONI OF PETB03I) TO
                   ACTIONI OF W-PETB03I
           END-IF

           SET W-IE-POINTER TO ADDRESS OF SUPPLCDL OF W-PETB03I
           PERFORM R800-INPUT-EDIT

           SET W-IE-POINTER TO ADDRESS OF SUPPLSTL OF W-PETB03I
           PERFORM R800-INPUT-EDIT

           SET W-IE-POINTER TO ADDRESS OF SUPPLNML OF W-PETB03I
           PERFORM R800-INPUT-EDIT
           .
       ...
       R320-PERFORM-ACTION SECTION.
           ...
           IF  RETURNCODE OF W-LPETM003 = N'00'
              ...
              ELSE
                 MOVE LOW-VALUES TO SUPPLIDI OF W-PETB03I
                 MOVE 0          TO SUPPLIDL OF W-PETB03I
                 MOVE LOW-VALUES TO SUPPLCDI OF W-PETB03I
                 MOVE 0          TO SUPPLCDL OF W-PETB03I
                 MOVE LOW-VALUES TO SUPPLSTI OF W-PETB03I 
                 MOVE 0          TO SUPPLSTL OF W-PETB03I
                 MOVE LOW-VALUES TO SUPPLNMI OF W-PETB03I
                 MOVE 0          TO SUPPLNML OF W-PETB03I
                 MOVE LOW-VALUES TO CREBYI   OF W-PETB03I
                 MOVE 0          TO CREBYL   OF W-PETB03I
                 MOVE LOW-VALUES TO CREDATEI OF W-PETB03I
                 MOVE 0          TO CREDATEL OF W-PETB03I
                 MOVE LOW-VALUES TO UPDBYI   OF W-PETB03I
                 MOVE 0          TO UPDBYL   OF W-PETB03I
                 MOVE LOW-VALUES TO UPDDATEI OF W-PETB03I
                 MOVE 0          TO UPDDATEL OF W-PETB03I
              END-IF

              MOVE LOW-VALUES TO ACTIONI OF W-PETB03I
              MOVE 0          TO ACTIONL OF W-PETB03I
           END-IF
           .
