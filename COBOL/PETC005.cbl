      ...
      *===============================================================*
       R001-INIT SECTION.
           ...
           IF SW-CONT-FOUND
              ...
              MOVE P-CHAR(1:W-CONT-LENGTH) TO W-LPETM005
           END-IF
      ...
      *===============================================================*
      * R005-CALL-PETM005: Call PETM005                               *
      *===============================================================*
       R005-CALL-PETM005 SECTION.
           ...
           IF RETURNCODE OF W-LPETM005 = N'00'
              ...
              END-EVALUATE
           ELSE
              IF RETURNCODE OF W-LPETM005 = N'04'
      ...
      *===============================================================*
       R009-FINISH SECTION.
           MOVE C-CHNL-NAME-LWW      TO W-CHNL-NAME
           MOVE C-CONT-NAME-LWW-03   TO W-CONT-NAME
           MOVE LENGTH OF W-LPETM005 TO W-CONT-LENGTH
           SET W-CONT-POINTER TO ADDRESS OF W-LPETM005
