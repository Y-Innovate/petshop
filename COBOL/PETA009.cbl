      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA009.
       MAIN SECTION.
           PERFORM R001-INIT

           PERFORM R002-CHECKPARM

           IF RETURNCODE OF W-LPETA009 = N'00'
              EVALUATE OPCODE OF W-LPETA009
              WHEN N'C'
                 PERFORM R110-INSERT
              WHEN N'R'
                 PERFORM R120-SELECT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA009 TO W-LPETA009

           MOVE N'00' TO RETURNCODE OF W-LPETA009
           MOVE N'00' TO REASONCODE OF W-LPETA009
           MOVE SPACES TO INFOMESSAGE OF W-LPETA009
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA009 NOT = N'C'
           AND OPCODE OF W-LPETA009 NOT = N'R'
           AND OPCODE OF W-LPETA009 NOT = N'U'
           AND OPCODE OF W-LPETA009 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA009
              MOVE N'01' TO REASONCODE OF W-LPETA009
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA009
           END-IF

           IF OPCODE OF W-LPETA009 NOT = N'C'
              IF  RETURNCODE OF W-LPETA009 = N'00'
              AND PURCHASEID OF W-LPETA009 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA009
                 MOVE N'02' TO REASONCODE OF W-LPETA009
                 MOVE N'PURCHASEID is required' TO
                      INFOMESSAGE OF W-LPETA009
              END-IF
           END-IF

           IF OPCODE OF W-LPETA009 = N'C'
           OR OPCODE OF W-LPETA009 = N'U'
              IF   RETURNCODE OF W-LPETA009 = N'00'
              AND (PURCHASEDATE OF W-LPETA009 = SPACES
              OR   PURCHASEDATE OF W-LPETA009 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA009
                 MOVE N'03' TO REASONCODE OF W-LPETA009
                 MOVE N'PURCHASEDATE is required' TO
                      INFOMESSAGE OF W-LPETA009
              END-IF

              IF CREATEDBY OF W-LPETA009 = SPACES
              OR CREATEDBY OF W-LPETA009 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA009 = SPACES
              OR UPDATEDBY OF W-LPETA009 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA009 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA009
                    END-IF

                    IF UPDATEDBY OF W-LPETA009 = SPACES
                    OR UPDATEDBY OF W-LPETA009 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA009
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA009
                    MOVE N'90' TO REASONCODE OF W-LPETA009
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE PURCHASEID  OF DCLTBPET009 TO
                   PURCHASEID  OF W-LPETA009
              MOVE CREATEDDATE OF DCLTBPET009 TO
                   CREATEDDATE OF W-LPETA009
              MOVE UPDATEDDATE OF DCLTBPET009 TO
                   UPDATEDDATE OF W-LPETA009
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA009
              MOVE N'11' TO REASONCODE OF W-LPETA009
              MOVE N'TBPET009 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA009
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA009
              MOVE N'12' TO REASONCODE OF W-LPETA009
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA009
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE PURCHASEID OF W-LPETA009 TO PURCHASEID OF DCLTBPET009
           ...
           WHEN 0
              MOVE PURCHASEDATE OF DCLTBPET009 TO
                   PURCHASEDATE OF W-LPETA009
              IF CUSTOMERID-IND OF DCLTBPET009 < 0
                 MOVE 0 TO CUSTOMERID OF W-LPETA009
              ELSE
                 MOVE CUSTOMERID OF DCLTBPET009 TO
                      CUSTOMERID OF W-LPETA009
              END-IF
              ...
              MOVE UPDATEDDATE OF DCLTBPET009 TO
                   UPDATEDDATE OF W-LPETA009
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETA009
                MOVE N'01' TO REASONCODE OF W-LPETA009
                MOVE N'TBPET009 entry not found' TO
                   INFOMESSAGE OF W-LPETA009
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETA009
                MOVE N'21' TO REASONCODE OF W-LPETA009
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA009
              MOVE N'31' TO REASONCODE OF W-LPETA009
              MOVE N'TBPET009 entry not found' TO
                   INFOMESSAGE OF W-LPETA009 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA009
              MOVE N'32' TO REASONCODE OF W-LPETA009
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA009
              MOVE N'41' TO REASONCODE OF W-LPETA009
              MOVE N'TBPET009 entry not found' TO
                   INFOMESSAGE OF W-LPETA009
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA009
              MOVE N'42' TO REASONCODE OF W-LPETA009
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE FUNCTION DISPLAY-OF(PURCHASEDATE OF W-LPETA009) TO
                PURCHASEDATE OF DCLTBPET009
           IF CUSTOMERID OF W-LPETA009 = 0
              MOVE -1 TO CUSTOMERID-IND OF DCLTBPET009
              MOVE 0 TO CUSTOMERID OF DCLTBPET009
           ELSE
              MOVE 0 TO CUSTOMERID-IND OF DCLTBPET009
              MOVE CUSTOMERID OF W-LPETA009 TO CUSTOMERID OF DCLTBPET009
           END-IF
           MOVE CREATEDBY    OF W-LPETA009 TO CREATEDBY   OF DCLTBPET009
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETA009) TO
              CREATEDDATE OF DCLTBPET009
           MOVE UPDATEDBY    OF W-LPETA009 TO UPDATEDBY   OF DCLTBPET009
           MOVE FUNCTION DISPLAY-OF(UPDATEDDATE OF W-LPETA009) TO
