      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA002.
       MAIN SECTION.
           PERFORM R001-INIT

           PERFORM R002-CHECKPARM

           IF RETURNCODE OF W-LPETA002 = N'00'
              EVALUATE OPCODE OF W-LPETA002
              WHEN N'C'
                 PERFORM R110-INSERT
              WHEN N'R'
                 PERFORM R120-SELECT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA002 TO W-LPETA002

           MOVE N'00' TO RETURNCODE OF W-LPETA002
           MOVE N'00' TO REASONCODE OF W-LPETA002
           MOVE SPACES TO INFOMESSAGE OF W-LPETA002
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA002 NOT = N'C'
           AND OPCODE OF W-LPETA002 NOT = N'R'
           AND OPCODE OF W-LPETA002 NOT = N'U'
           AND OPCODE OF W-LPETA002 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA002
              MOVE N'01' TO REASONCODE OF W-LPETA002
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA002
           END-IF

           IF  OPCODE OF W-LPETA002 NOT = N'C'
           AND OPCODE OF W-LPETA002 NOT = N'R'
              IF  RETURNCODE OF W-LPETA002 = N'00'
              AND STOREID OF W-LPETA002 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA002
                 MOVE N'02' TO REASONCODE OF W-LPETA002
                 MOVE N'STOREID is required' TO
                      INFOMESSAGE OF W-LPETA002
              END-IF
           END-IF

           IF OPCODE OF W-LPETA002 = N'R'
              IF   RETURNCODE OF W-LPETA002 = N'00'
              AND  STOREID    OF W-LPETA002 = 0
              AND (STORECODE  OF W-LPETA002 = SPACES
              OR   STORECODE  OF W-LPETA002 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA002
                 MOVE N'03' TO REASONCODE OF W-LPETA002
                 MOVE N'STORECODE is required' TO
                      INFOMESSAGE OF W-LPETA002
              END-IF
           END-IF

           IF OPCODE OF W-LPETA002 = N'C'
           OR OPCODE OF W-LPETA002 = N'U'
              IF  RETURNCODE OF W-LPETA002 = N'00'
              AND STORECODE OF W-LPETA002 = SPACES
                 MOVE N'08' TO RETURNCODE OF W-LPETA002
                 MOVE N'03' TO REASONCODE OF W-LPETA002
              ...
              IF  RETURNCODE OF W-LPETA002 = N'00'
              AND STORESTATUS OF W-LPETA002 = SPACES
                 MOVE N'08' TO RETURNCODE OF W-LPETA002
                 MOVE N'04' TO REASONCODE OF W-LPETA002
                 MOVE N'STORESTATUS is required' TO
                      INFOMESSAGE OF W-LPETA002
              END-IF

              IF   RETURNCODE OF W-LPETA002 = N'00'
              AND (STORENAME-LEN OF W-LPETA002 = 0
              OR   STORENAME-TEXT OF W-LPETA002 (1:
                      STORENAME-LEN OF W-LPETA002) = SPACES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA002
                 MOVE N'05' TO REASONCODE OF W-LPETA002
                 MOVE N'STORENAME is required' TO
                      INFOMESSAGE OF W-LPETA002
              END-IF

              IF CREATEDBY OF W-LPETA002 = SPACES
              OR CREATEDBY OF W-LPETA002 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA002 = SPACES
              OR UPDATEDBY OF W-LPETA002 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA002 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA002
                    END-IF

                    IF UPDATEDBY OF W-LPETA002 = SPACES
                    OR UPDATEDBY OF W-LPETA002 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA002
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA002
                    MOVE N'90' TO REASONCODE OF W-LPETA002
      ...
      *===============================================================*
       R110-INSERT SECTION.
           ...
           EVALUATE SQLCODE
           WHEN 0
              MOVE STOREID     OF DCLTBPET002 TO STOREID OF W-LPETA002
              MOVE CREATEDDATE OF DCLTBPET002 TO
                   CREATEDDATE OF W-LPETA002
              MOVE UPDATEDDATE OF DCLTBPET002 TO
                   UPDATEDDATE OF W-LPETA002
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA002
              MOVE N'11' TO REASONCODE OF W-LPETA002
              MOVE N'TBPET002 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA002
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA002
              MOVE N'12' TO REASONCODE OF W-LPETA002
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA002
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE STOREID   OF W-LPETA002 TO STOREID   OF DCLTBPET002
           MOVE STORECODE OF W-LPETA002 TO STORECODE OF DCLTBPET002
           ...
           WHEN 0
              ...
              MOVE UPDATEDDATE OF DCLTBPET002 TO
                   UPDATEDDATE OF W-LPETA002
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETA002
                MOVE N'01' TO REASONCODE OF W-LPETA002
                MOVE N'TBPET002 entry not found' TO
                   INFOMESSAGE OF W-LPETA002
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETA002
                MOVE N'21' TO REASONCODE OF W-LPETA002
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA002
              MOVE N'31' TO REASONCODE OF W-LPETA002
              MOVE N'TBPET002 entry not found' TO
                   INFOMESSAGE OF W-LPETA002 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA002
              MOVE N'32' TO REASONCODE OF W-LPETA002
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA002
              MOVE N'41' TO REASONCODE OF W-LPETA002
              MOVE N'TBPET002 entry not found' TO
                   INFOMESSAGE OF W-LPETA002
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA002
              MOVE N'42' TO REASONCODE OF W-LPETA002
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE STOREID     OF W-LPETA002 TO STOREID     OF DCLTBPET002
           MOVE STORECODE   OF W-LPETA002 TO STORECODE   OF DCLTBPET002
           MOVE STORESTATUS OF W-LPETA002 TO STORESTATUS OF DCLTBPET002
           MOVE STORENAME   OF W-LPETA002 TO STORENAME   OF DCLTBPET002
           MOVE STORENAME-LEN OF W-LPETA002 TO
                STORENAMEU-LEN OF DCLTBPET002
           MOVE FUNCTION UPPER-CASE(STORENAME-TEXT OF W-LPETA002(1:
                   STORENAME-LEN OF W-LPETA002)) TO
                STORENAMEU-TEXT OF DCLTBPET002
           MOVE CREATEDBY   OF W-LPETA002 TO CREATEDBY   OF DCLTBPET002
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETA002) TO
              CREATEDDATE   OF DCLTBPET002
           MOVE UPDATEDBY   OF W-LPETA002 TO UPDATEDBY   OF DCLTBPET002
           MOVE FUNCTION DISPLAY-OF(UPDATEDDATE OF W-LPETA002) TO
