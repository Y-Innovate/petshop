      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA012.
       MAIN SECTION.
           PERFORM R001-INIT

           PERFORM R002-CHECKPARM

           IF RETURNCODE OF W-LPETA012 = N'00'
              EVALUATE OPCODE OF W-LPETA012
              WHEN N'C'
                 PERFORM R110-INSERT
              WHEN N'R'
                 PERFORM R120-SELECT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA012 TO W-LPETA012

           MOVE N'00' TO RETURNCODE OF W-LPETA012
           MOVE N'00' TO REASONCODE OF W-LPETA012
           MOVE SPACES TO INFOMESSAGE OF W-LPETA012
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA012 NOT = N'C'
           AND OPCODE OF W-LPETA012 NOT = N'R'
           AND OPCODE OF W-LPETA012 NOT = N'U'
           AND OPCODE OF W-LPETA012 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA012
              MOVE N'01' TO REASONCODE OF W-LPETA012
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA012
           END-IF

           IF OPCODE OF W-LPETA012 NOT = N'C'
              IF  RETURNCODE OF W-LPETA012 = N'00'
              AND CONTACTINFOID OF W-LPETA012 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA012
                 MOVE N'02' TO REASONCODE OF W-LPETA012
                 MOVE N'CONTACTINFOID is required' TO
                      INFOMESSAGE OF W-LPETA012
              END-IF
           END-IF

           IF OPCODE OF W-LPETA012 = N'C'
           OR OPCODE OF W-LPETA012 = N'U'
              IF   RETURNCODE OF W-LPETA012 = N'00'
              AND (CONTACTINFOTYPE OF W-LPETA012 = SPACES
              OR   CONTACTINFOTYPE OF W-LPETA012 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA012
                 MOVE N'03' TO REASONCODE OF W-LPETA012
                 MOVE N'CONTACTINFOTYPE is required' TO
                      INFOMESSAGE OF W-LPETA012
              END-IF

              IF   RETURNCODE OF W-LPETA012 = N'00'
              AND (OWNERTYPE OF W-LPETA012 = SPACES
              OR   OWNERTYPE OF W-LPETA012 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA012
                 MOVE N'04' TO REASONCODE OF W-LPETA012
                 MOVE N'OWNERTYPE is required' TO
                      INFOMESSAGE OF W-LPETA012
              END-IF

              IF  RETURNCODE OF W-LPETA012 = N'00'
              AND OWNERID OF W-LPETA012 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA012
                 MOVE N'05' TO REASONCODE OF W-LPETA012
                 MOVE N'OWNERID is required' TO
                      INFOMESSAGE OF W-LPETA012
              END-IF

              IF   RETURNCODE OF W-LPETA012 = N'00'
              AND (CONTACTDATA-LEN OF W-LPETA012 = 0
              OR   CONTACTDATA-TEXT OF W-LPETA012(1:
                      CONTACTDATA-LEN OF W-LPETA012) = SPACES
              OR   CONTACTDATA-TEXT OF W-LPETA012(1:
                      CONTACTDATA-LEN OF W-LPETA012) = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA012
                 MOVE N'06' TO REASONCODE OF W-LPETA012
                 MOVE N'CONTACTDATA is required' TO
                      INFOMESSAGE OF W-LPETA012
              END-IF

              IF CREATEDBY OF W-LPETA012 = SPACES
              OR CREATEDBY OF W-LPETA012 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA012 = SPACES
              OR UPDATEDBY OF W-LPETA012 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA012 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA012
                    END-IF

                    IF UPDATEDBY OF W-LPETA012 = SPACES
                    OR UPDATEDBY OF W-LPETA012 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA012
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA012
                    MOVE N'90' TO REASONCODE OF W-LPETA012
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE CONTACTINFOID OF DCLTBPET012 TO
                   CONTACTINFOID OF W-LPETA012
              MOVE CREATEDDATE   OF DCLTBPET012 TO
                   CREATEDDATE   OF W-LPETA012
              MOVE UPDATEDDATE   OF DCLTBPET012 TO
                   UPDATEDDATE   OF W-LPETA012
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA012
              MOVE N'11' TO REASONCODE OF W-LPETA012
              MOVE N'TBPET012 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA012
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA012
              MOVE N'12' TO REASONCODE OF W-LPETA012
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA012
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE CONTACTINFOID OF W-LPETA012 TO
           ...
           WHEN 0
              MOVE CONTACTINFOTYPE OF DCLTBPET012 TO
                   CONTACTINFOTYPE OF W-LPETA012
              MOVE OWNERTYPE       OF DCLTBPET012 TO
                   OWNERTYPE       OF W-LPETA012
              MOVE OWNERID         OF DCLTBPET012 TO
                   OWNERID         OF W-LPETA012
              IF CONTACTDATA-IND OF DCLTBPET012 < 0
                 MOVE 0 TO CONTACTDATA-LEN OF W-LPETA012
                 MOVE LOW-VALUES TO CONTACTDATA-TEXT OF W-LPETA012
              ELSE
                 MOVE CONTACTDATA OF DCLTBPET012 TO
                      CONTACTDATA OF W-LPETA012
              END-IF
              IF FROMDATE-IND OF DCLTBPET012 < 0
                 MOVE LOW-VALUES TO FROMDATE OF W-LPETA012
              ELSE
                 MOVE FUNCTION NATIONAL-OF(FROMDATE OF DCLTBPET012) TO
                      FROMDATE OF W-LPETA012
              END-IF
              IF TODATE-IND OF DCLTBPET012 < 0
                 MOVE LOW-VALUES TO TODATE OF W-LPETA012
              ELSE
                 MOVE FUNCTION NATIONAL-OF(TODATE OF DCLTBPET012) TO
                      TODATE OF W-LPETA012
              END-IF
              ...
              MOVE UPDATEDDATE OF DCLTBPET012 TO
                   UPDATEDDATE OF W-LPETA012
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETA012
                MOVE N'01' TO REASONCODE OF W-LPETA012
                MOVE N'TBPET012 entry not found' TO
                   INFOMESSAGE OF W-LPETA012
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETA012
                MOVE N'21' TO REASONCODE OF W-LPETA012
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA012
              MOVE N'31' TO REASONCODE OF W-LPETA012
              MOVE N'TBPET012 entry not found' TO
                   INFOMESSAGE OF W-LPETA012 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA012
              MOVE N'32' TO REASONCODE OF W-LPETA012
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA012
              MOVE N'41' TO REASONCODE OF W-LPETA012
              MOVE N'TBPET012 entry not found' TO
                   INFOMESSAGE OF W-LPETA012
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA012
              MOVE N'42' TO REASONCODE OF W-LPETA012
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE CONTACTINFOTYPE OF W-LPETA012 TO
                CONTACTINFOTYPE OF DCLTBPET012
           MOVE OWNERTYPE OF W-LPETA012 TO OWNERTYPE OF DCLTBPET012
           MOVE OWNERID   OF W-LPETA012 TO OWNERID   OF DCLTBPET012
           IF CONTACTDATA-LEN OF W-LPETA012 = 0
           OR CONTACTDATA-TEXT OF W-LPETA012(1:
                CONTACTDATA-LEN OF W-LPETA012) = SPACES
           OR CONTACTDATA-TEXT OF W-LPETA012(1:
                CONTACTDATA-LEN OF W-LPETA012) = LOW-VALUES
           ...
           ELSE
              ...
              MOVE CONTACTDATA OF W-LPETA012 TO
                   CONTACTDATA OF DCLTBPET012
           END-IF
           IF FROMDATE OF W-LPETA012 = SPACES
           OR FROMDATE OF W-LPETA012 = LOW-VALUES
              MOVE -1 TO FROMDATE-IND OF DCLTBPET012
              MOVE LOW-VALUES TO FROMDATE OF DCLTBPET012
           ELSE
              MOVE 0 TO FROMDATE-IND OF DCLTBPET012
              MOVE FUNCTION DISPLAY-OF(FROMDATE OF W-LPETA012) TO
                   FROMDATE OF DCLTBPET012
           END-IF
           IF TODATE OF W-LPETA012 = SPACES
           OR TODATE OF W-LPETA012 = LOW-VALUES
              MOVE -1 TO TODATE-IND OF DCLTBPET012
              MOVE LOW-VALUES TO TODATE OF DCLTBPET012
           ELSE
              MOVE 0 TO TODATE-IND OF DCLTBPET012
              MOVE FUNCTION DISPLAY-OF(TODATE OF W-LPETA012) TO
                   TODATE OF DCLTBPET012
           END-IF
           MOVE CREATEDBY    OF W-LPETA012 TO CREATEDBY   OF DCLTBPET012
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETA012) TO
              CREATEDDATE OF DCLTBPET012
           MOVE UPDATEDBY    OF W-LPETA012 TO UPDATEDBY   OF DCLTBPET012
           MOVE FUNCTION DISPLAY-OF(UPDATEDDATE OF W-LPETA012) TO
