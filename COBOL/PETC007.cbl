      ...
      *===============================================================*
       R001-INIT SECTION.
           ...
           IF SW-CONT-FOUND
              ...
              MOVE P-CHAR(1:W-CONT-LENGTH) TO W-LPETM007
           END-IF
      ...
      *===============================================================*
       R009-FINISH SECTION.
           MOVE C-CHNL-NAME-LWW      TO W-CHNL-NAME
           MOVE C-CONT-NAME-LWW-03   TO W-CONT-NAME
           MOVE LENGTH OF W-LPETM007 TO W-CONT-LENGTH
           SET W-CONT-POINTER TO ADDRESS OF W-LPETM007
