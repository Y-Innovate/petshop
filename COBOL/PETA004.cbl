      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA004.
       MAIN SECTION.
           PERFORM R001-INIT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA004 TO W-LPETA004

           MOVE N'00' TO RETURNCODE OF W-LPETA004
           MOVE N'00' TO REASONCODE OF W-LPETA004
           MOVE SPACES TO INFOMESSAGE OF W-LPETA004
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA004 NOT = N'C'
           AND OPCODE OF W-LPETA004 NOT = N'R'
           AND OPCODE OF W-LPETA004 NOT = N'U'
           AND OPCODE OF W-LPETA004 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA004
              MOVE N'01' TO REASONCODE OF W-LPETA004
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA004
           END-IF

           IF  OPCODE OF W-LPETA004 NOT = N'C'
           AND OPCODE OF W-LPETA004 NOT = N'R'
              IF  RETURNCODE OF W-LPETA004 = N'00'
              AND PRODUCTID OF W-LPETA004 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA004
                 MOVE N'02' TO REASONCODE OF W-LPETA004
                 MOVE N'PRODUCTID is required' TO
                      INFOMESSAGE OF W-LPETA004
              END-IF
           END-IF

           IF OPCODE OF W-LPETA004 = N'R'
              IF   RETURNCODE  OF W-LPETA004 = N'00'
              AND  PRODUCTID   OF W-LPETA004 = 0
              AND (PRODUCTCODE OF W-LPETA004 = SPACES
              OR   PRODUCTCODE OF W-LPETA004 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA004
                 MOVE N'03' TO REASONCODE OF W-LPETA004
           ...
           OR OPCODE OF W-LPETA004 = N'U'
              ...
              IF  RETURNCODE OF W-LPETA004 = N'00'
              AND PRODUCTSTATUS OF W-LPETA004 = SPACES
                 MOVE N'08' TO RETURNCODE OF W-LPETA004
                 MOVE N'04' TO REASONCODE OF W-LPETA004
                 MOVE N'PRODUCTSTATUS is required' TO
                      INFOMESSAGE OF W-LPETA004
              END-IF

              IF   RETURNCODE OF W-LPETA004 = N'00'
              AND (PRODUCTNAME-LEN OF W-LPETA004 = 0
              OR   PRODUCTNAME-TEXT OF W-LPETA004 (1:
                      PRODUCTNAME-LEN OF W-LPETA004) = SPACES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA004
                 MOVE N'05' TO REASONCODE OF W-LPETA004
                 MOVE N'PRODUCTNAME is required' TO
                      INFOMESSAGE OF W-LPETA004
              END-IF

              IF  RETURNCODE OF W-LPETA004 = N'00'
              AND GROUPCODE OF W-LPETA004 = SPACES
                 MOVE N'08' TO RETURNCODE OF W-LPETA004
                 MOVE N'06' TO REASONCODE OF W-LPETA004
                 MOVE N'GROUPCODE is required' TO
                      INFOMESSAGE OF W-LPETA004
              END-IF

              IF  RETURNCODE OF W-LPETA004 = N'00'
              AND SUPPLIERID OF W-LPETA004 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA004
                 MOVE N'07' TO REASONCODE OF W-LPETA004
                 MOVE N'SUPPLIERID is required' TO
                      INFOMESSAGE OF W-LPETA004
              END-IF

              IF CREATEDBY OF W-LPETA004 = SPACES
              OR CREATEDBY OF W-LPETA004 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA004 = SPACES
              OR UPDATEDBY OF W-LPETA004 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA004 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA004
                    END-IF

                    IF UPDATEDBY OF W-LPETA004 = SPACES
                    OR UPDATEDBY OF W-LPETA004 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA004
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA004
                    MOVE N'90' TO REASONCODE OF W-LPETA004
      ...
      *===============================================================*
       R110-INSERT SECTION.
           ...
           EVALUATE SQLCODE
           WHEN 0
              MOVE PRODUCTID   OF DCLTBPET004 TO PRODUCTID OF W-LPETA004
              MOVE CREATEDDATE OF DCLTBPET004 TO
                   CREATEDDATE OF W-LPETA004
              MOVE UPDATEDDATE OF DCLTBPET004 TO
                   UPDATEDDATE OF W-LPETA004
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA004
              MOVE N'11' TO REASONCODE OF W-LPETA004
              MOVE N'TBPET004 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA004
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA004
              MOVE N'12' TO REASONCODE OF W-LPETA004
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA004
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE PRODUCTID   OF W-LPETA004 TO PRODUCTID   OF DCLTBPET004
           MOVE PRODUCTCODE OF W-LPETA004 TO PRODUCTCODE OF DCLTBPET004
           ...
           WHEN 0
              ...
              MOVE UPDATEDDATE   OF DCLTBPET004 TO
                   UPDATEDDATE   OF W-LPETA004
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETA004
                MOVE N'01' TO REASONCODE OF W-LPETA004
                MOVE N'TBPET004 entry not found' TO
                   INFOMESSAGE OF W-LPETA004
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETA004
                MOVE N'21' TO REASONCODE OF W-LPETA004
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA004
              MOVE N'31' TO REASONCODE OF W-LPETA004
              MOVE N'TBPET004 entry not found' TO
                   INFOMESSAGE OF W-LPETA004 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA004
              MOVE N'32' TO REASONCODE OF W-LPETA004
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA004
              MOVE N'41' TO REASONCODE OF W-LPETA004
              MOVE N'TBPET004 entry not found' TO
                   INFOMESSAGE OF W-LPETA004
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA004
              MOVE N'42' TO REASONCODE OF W-LPETA004
