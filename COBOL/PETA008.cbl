      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETA008.
       MAIN SECTION.
           PERFORM R001-INIT

           PERFORM R002-CHECKPARM

           IF RETURNCODE OF W-LPETA008 = N'00'
              EVALUATE OPCODE OF W-LPETA008
              WHEN N'C'
                 PERFORM R110-INSERT
              WHEN N'R'
                 PERFORM R120-SELECT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETA008 TO W-LPETA008

           MOVE N'00' TO RETURNCODE OF W-LPETA008
           MOVE N'00' TO REASONCODE OF W-LPETA008
           MOVE SPACES TO INFOMESSAGE OF W-LPETA008
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETA008 NOT = N'C'
           AND OPCODE OF W-LPETA008 NOT = N'R'
           AND OPCODE OF W-LPETA008 NOT = N'U'
           AND OPCODE OF W-LPETA008 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETA008
              MOVE N'01' TO REASONCODE OF W-LPETA008
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETA008
           END-IF

           IF OPCODE OF W-LPETA008 NOT = N'C'
              IF  RETURNCODE OF W-LPETA008 = N'00'
              AND CUSTOMERID OF W-LPETA008 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETA008
                 MOVE N'02' TO REASONCODE OF W-LPETA008
                 MOVE N'CUSTOMERID is required' TO
                      INFOMESSAGE OF W-LPETA008
              END-IF
           END-IF

           IF OPCODE OF W-LPETA008 = N'C'
           OR OPCODE OF W-LPETA008 = N'U'
              IF   RETURNCODE OF W-LPETA008 = N'00'
              AND (LASTNAME-LEN OF W-LPETA008 = 0
              OR   LASTNAME-TEXT OF W-LPETA008(1:
                      LASTNAME-LEN OF W-LPETA008) = SPACES)
                 MOVE N'08' TO RETURNCODE OF W-LPETA008
                 MOVE N'03' TO REASONCODE OF W-LPETA008
                 MOVE N'LASTNAME is required' TO
                      INFOMESSAGE OF W-LPETA008
              END-IF

              IF CREATEDBY OF W-LPETA008 = SPACES
              OR CREATEDBY OF W-LPETA008 = LOW-VALUES
              OR UPDATEDBY OF W-LPETA008 = SPACES
              OR UPDATEDBY OF W-LPETA008 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETA008 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETA008
                    END-IF

                    IF UPDATEDBY OF W-LPETA008 = SPACES
                    OR UPDATEDBY OF W-LPETA008 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETA008
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETA008
                    MOVE N'90' TO REASONCODE OF W-LPETA008
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE CUSTOMERID  OF DCLTBPET008 TO
                   CUSTOMERID  OF W-LPETA008
              MOVE CREATEDDATE OF DCLTBPET008 TO
                   CREATEDDATE OF W-LPETA008
              MOVE UPDATEDDATE OF DCLTBPET008 TO
                   UPDATEDDATE OF W-LPETA008
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETA008
              MOVE N'11' TO REASONCODE OF W-LPETA008
              MOVE N'TBPET008 duplicate entry' TO
                   INFOMESSAGE OF W-LPETA008
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA008
              MOVE N'12' TO REASONCODE OF W-LPETA008
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETA008
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE CUSTOMERID OF W-LPETA008 TO CUSTOMERID OF DCLTBPET008
           ...
           WHEN 0
              MOVE LASTNAME  OF DCLTBPET008 TO
                   LASTNAME  OF W-LPETA008
              MOVE LASTNAMEU OF DCLTBPET008 TO
                   LASTNAMEU OF W-LPETA008
              IF FIRSTNAME-IND OF DCLTBPET008 < 0
                 MOVE 0 TO FIRSTNAME-LEN OF W-LPETA008
                 MOVE LOW-VALUES TO FIRSTNAME-TEXT OF W-LPETA008
              ELSE
                 MOVE FIRSTNAME OF DCLTBPET008 TO
                      FIRSTNAME OF W-LPETA008 
              END-IF
              IF FIRSTNAMEU-IND OF DCLTBPET008 < 0
                 MOVE 0 TO FIRSTNAMEU-LEN OF W-LPETA008
                 MOVE LOW-VALUES TO FIRSTNAME-TEXT OF W-LPETA008
              ELSE
                 MOVE FIRSTNAMEU OF DCLTBPET008 TO
                      FIRSTNAMEU OF W-LPETA008
              END-IF
              IF MIDDLENAME-IND OF DCLTBPET008 < 0
                 MOVE 0 TO MIDDLENAME-LEN OF W-LPETA008
                 MOVE LOW-VALUES TO MIDDLENAME-TEXT OF W-LPETA008
              END-IF
              IF DATEOFBIRTH-IND OF DCLTBPET008 < 0
                 MOVE LOW-VALUES TO DATEOFBIRTH IN W-LPETA008
              ELSE
                 MOVE DATEOFBIRTH OF DCLTBPET008 TO
                      DATEOFBIRTH OF W-LPETA008
              END-IF
              IF GENDER-IND OF DCLTBPET008 < 0
                 MOVE LOW-VALUE TO GENDER OF W-LPETA008
              ELSE
                 MOVE GENDER OF DCLTBPET008 TO GENDER OF W-LPETA008
              END-IF
              ...
              MOVE UPDATEDDATE OF DCLTBPET008 TO
                   UPDATEDDATE OF W-LPETA008
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETA008
                MOVE N'01' TO REASONCODE OF W-LPETA008
                MOVE N'TBPET008 entry not found' TO
                   INFOMESSAGE OF W-LPETA008
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETA008
                MOVE N'21' TO REASONCODE OF W-LPETA008
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA008
              MOVE N'31' TO REASONCODE OF W-LPETA008
              MOVE N'TBPET008 entry not found' TO
                   INFOMESSAGE OF W-LPETA008 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA008
              MOVE N'32' TO REASONCODE OF W-LPETA008
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETA008
              MOVE N'41' TO REASONCODE OF W-LPETA008
              MOVE N'TBPET008 entry not found' TO
                   INFOMESSAGE OF W-LPETA008
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETA008
              MOVE N'42' TO REASONCODE OF W-LPETA008
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE LASTNAME  OF W-LPETA008 TO LASTNAME OF DCLTBPET008
           MOVE LASTNAME-LEN  OF W-LPETA008 TO
                LASTNAMEU-LEN OF DCLTBPET008
           MOVE FUNCTION UPPER-CASE(LASTNAME-TEXT OF W-LPETA008(1:
                   LASTNAME-LEN OF W-LPETA008)) TO
                LASTNAMEU-TEXT OF DCLTBPET008
           IF FIRSTNAME-LEN OF W-LPETA008 = 0
           ...
           ELSE
              ...
              MOVE FIRSTNAME OF W-LPETA008 TO FIRSTNAME OF DCLTBPET008
              MOVE FIRSTNAME-LEN OF W-LPETA008 TO
                   FIRSTNAMEU-LEN OF DCLTBPET008
              MOVE FUNCTION UPPER-CASE(FIRSTNAME-TEXT OF W-LPETA008(1:
                      FIRSTNAME-LEN OF W-LPETA008)) TO
                   FIRSTNAMEU-TEXT OF W-LPETA008
           END-IF
           IF MIDDLENAME-LEN OF W-LPETA008 = 0
           ...
           ELSE
              ...
              MOVE MIDDLENAME OF W-LPETA008 TO MIDDLENAME OF DCLTBPET008
           END-IF
           IF DATEOFBIRTH OF W-LPETA008 = LOW-VALUES
           OR DATEOFBIRTH OF W-LPETA008 = SPACES
           ...
           ELSE
              ...
              MOVE DATEOFBIRTH OF W-LPETA008 TO
                   DATEOFBIRTH OF DCLTBPET008
           END-IF
           IF GENDER OF W-LPETA008 = LOW-VALUE
           OR GENDER OF W-LPETA008 = SPACE
              MOVE -1 TO GENDER-IND OF DCLTBPET008
              MOVE LOW-VALUE TO GENDER OF DCLTBPET008
           ELSE
              MOVE 0 TO GENDER-IND OF DCLTBPET008
              MOVE GENDER OF W-LPETA008 TO GENDER OF DCLTBPET008
           END-IF
           MOVE CREATEDBY    OF W-LPETA008 TO CREATEDBY   OF DCLTBPET008
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETA008) TO
              CREATEDDATE OF DCLTBPET008
           MOVE UPDATEDBY    OF W-LPETA008 TO UPDATEDBY   OF DCLTBPET008
           MOVE FUNCTION DISPLAY-OF(UPDATEDDATE OF W-LPETA008) TO
