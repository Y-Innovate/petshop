      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETM011.
       MAIN SECTION.
           PERFORM R001-INIT

           PERFORM R002-CHECKPARM

           IF RETURNCODE OF W-LPETM011 = N'00'
              EVALUATE OPCODE OF W-LPETM011
              WHEN N'C'
                 PERFORM R110-INSERT
              WHEN N'R'
                 PERFORM R120-SELECT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETM011 TO W-LPETM011

           MOVE N'00' TO RETURNCODE OF W-LPETM011
           MOVE N'00' TO REASONCODE OF W-LPETM011
           MOVE SPACES TO INFOMESSAGE OF W-LPETM011
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETM011 NOT = N'C'
           AND OPCODE OF W-LPETM011 NOT = N'R'
           AND OPCODE OF W-LPETM011 NOT = N'U'
           AND OPCODE OF W-LPETM011 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETM011
              MOVE N'01' TO REASONCODE OF W-LPETM011
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETM011
           END-IF

           IF OPCODE OF W-LPETM011 NOT = N'C'
              IF  RETURNCODE OF W-LPETM011 = N'00'
              AND ADDRESSID  OF W-LPETM011 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM011
                 MOVE N'02' TO REASONCODE OF W-LPETM011
                 MOVE N'ADDRESSID is required' TO
                      INFOMESSAGE OF W-LPETM011
              END-IF
           END-IF

           IF OPCODE OF W-LPETM011 = N'C'
           OR OPCODE OF W-LPETM011 = N'U'
              IF   RETURNCODE OF W-LPETM011 = N'00'
              AND (ADDRESSTYPE OF W-LPETM011 = SPACES
              OR   ADDRESSTYPE OF W-LPETM011 = LOW-VALUES)
                 MOVE N'08' TO RETURNCODE OF W-LPETM011
                 MOVE N'03' TO REASONCODE OF W-LPETM011
                 MOVE N'ADDRESSTYPE is required' TO
                      INFOMESSAGE OF W-LPETM011
              END-IF

              IF CREATEDBY OF W-LPETM011 = SPACES
              OR CREATEDBY OF W-LPETM011 = LOW-VALUES
              OR UPDATEDBY OF W-LPETM011 = SPACES
              OR UPDATEDBY OF W-LPETM011 = LOW-VALUES
                 ...
                 IF RETURNCODE OF W-LPETA900 = N'00'
                    ...
                    OR CREATEDBY OF W-LPETM011 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            CREATEDBY OF W-LPETM011
                    END-IF

                    IF UPDATEDBY OF W-LPETM011 = SPACES
                    OR UPDATEDBY OF W-LPETM011 = LOW-VALUES
                       MOVE USERID OF W-LPETA900 TO
                            UPDATEDBY OF W-LPETM011
                    END-IF
                 ELSE
                    MOVE N'08' TO RETURNCODE OF W-LPETM011
                    MOVE N'90' TO REASONCODE OF W-LPETM011
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              MOVE ADDRESSID   OF DCLTBPET011 TO
                   ADDRESSID   OF W-LPETM011
              MOVE CREATEDDATE OF DCLTBPET011 TO
                   CREATEDDATE OF W-LPETM011
              MOVE UPDATEDDATE OF DCLTBPET011 TO
                   UPDATEDDATE OF W-LPETM011
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETM011
              MOVE N'11' TO REASONCODE OF W-LPETM011
              MOVE N'TBPET011 duplicate entry' TO
                   INFOMESSAGE OF W-LPETM011
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETM011
              MOVE N'12' TO REASONCODE OF W-LPETM011
              STRING N'INSERT gave SQLCODE='
                     FUNCTION NATIONAL-OF(W-SQLCODE)
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETM011
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE ADDRESSID OF W-LPETM011 TO ADDRESSID OF DCLTBPET011
           ...
           WHEN 0
              MOVE ADDRESSTYPE OF DCLTBPET011 TO
                   ADDRESSTYPE OF W-LPETM011
              MOVE OWNERID     OF DCLTBPET011 TO
                   OWNERID     OF W-LPETM011
              IF FROMDATE-IND OF DCLTBPET011 < 0
                 MOVE LOW-VALUES TO FROMDATE OF W-LPETM011
              ELSE
                 MOVE FUNCTION NATIONAL-OF(FROMDATE OF DCLTBPET011) TO
                      FROMDATE OF W-LPETM011
              END-IF
              IF TODATE-IND OF DCLTBPET011 < 0
                 MOVE LOW-VALUES TO TODATE OF W-LPETM011
              ELSE
                 MOVE FUNCTION NATIONAL-OF(TODATE OF DCLTBPET011) TO
                      TODATE OF W-LPETM011
              END-IF
              IF ADDRESSLINE1-IND OF DCLTBPET011 < 0
                 MOVE 0 TO ADDRESSLINE1-LEN OF W-LPETM011
                 MOVE LOW-VALUES TO ADDRESSLINE1-TEXT OF W-LPETM011
              ELSE
                 MOVE ADDRESSLINE1 OF DCLTBPET011 TO
                      ADDRESSLINE1 OF W-LPETM011
              END-IF
              IF ADDRESSLINE2-IND OF DCLTBPET011 < 0
                 MOVE 0 TO ADDRESSLINE2-LEN OF W-LPETM011
                 MOVE LOW-VALUES TO ADDRESSLINE2-TEXT OF W-LPETM011
              ELSE
                 MOVE ADDRESSLINE2 OF DCLTBPET011 TO
                      ADDRESSLINE2 OF W-LPETM011
              END-IF
              IF POSTALCODE-IND OF DCLTBPET011 < 0
                 MOVE 0 TO POSTALCODE-LEN OF W-LPETM011
                 MOVE LOW-VALUES TO POSTALCODE-TEXT OF W-LPETM011
              ELSE
                 MOVE POSTALCODE OF DCLTBPET011 TO
                      POSTALCODE OF W-LPETM011
              END-IF
              IF CITY-IND OF DCLTBPET011 < 0
                 MOVE 0 TO CITY-LEN OF W-LPETM011
                 MOVE LOW-VALUES TO CITY-TEXT OF W-LPETM011
              ELSE
                 MOVE CITY OF DCLTBPET011 TO CITY OF W-LPETM011
              END-IF
              IF REGION-IND OF DCLTBPET011 < 0
                 MOVE 0 TO REGION-LEN OF W-LPETM011
                 MOVE LOW-VALUES TO REGION-TEXT OF W-LPETM011
              ELSE
                 MOVE REGION OF DCLTBPET011 TO REGION OF W-LPETM011
              END-IF
              IF COUNTRY-IND OF DCLTBPET011 < 0
                 MOVE 0 TO COUNTRY-LEN OF W-LPETM011
                 MOVE LOW-VALUES TO COUNTRY-TEXT OF W-LPETM011
              ELSE
                 MOVE COUNTRY OF DCLTBPET011 TO COUNTRY OF W-LPETM011
              END-IF
              ...
              MOVE UPDATEDDATE OF DCLTBPET011 TO
                   UPDATEDDATE OF W-LPETM011
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETM011
                MOVE N'01' TO REASONCODE OF W-LPETM011
                MOVE N'TBPET011 entry not found' TO
                   INFOMESSAGE OF W-LPETM011
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETM011
                MOVE N'21' TO REASONCODE OF W-LPETM011
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETM011
              MOVE N'31' TO REASONCODE OF W-LPETM011
              MOVE N'TBPET011 entry not found' TO
                   INFOMESSAGE OF W-LPETM011 
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETM011
              MOVE N'32' TO REASONCODE OF W-LPETM011
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETM011
              MOVE N'41' TO REASONCODE OF W-LPETM011
              MOVE N'TBPET011 entry not found' TO
                   INFOMESSAGE OF W-LPETM011
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETM011
              MOVE N'42' TO REASONCODE OF W-LPETM011
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE ADDRESSTYPE OF W-LPETM011 TO ADDRESSTYPE OF DCLTBPET011
           MOVE OWNERID     OF W-LPETM011 TO OWNERID     OF DCLTBPET011
           IF FROMDATE OF W-LPETM011 = SPACES
           OR FROMDATE OF W-LPETM011 = LOW-VALUES
              MOVE -1 TO FROMDATE-IND OF DCLTBPET011
              MOVE LOW-VALUES TO FROMDATE OF DCLTBPET011
           ELSE
              MOVE 0 TO FROMDATE-IND OF DCLTBPET011
              MOVE FUNCTION DISPLAY-OF(FROMDATE OF W-LPETM011) TO
                   FROMDATE OF DCLTBPET011
           END-IF
           IF TODATE OF W-LPETM011 = SPACES
           OR TODATE OF W-LPETM011 = LOW-VALUES
              MOVE -1 TO TODATE-IND OF DCLTBPET011
              MOVE LOW-VALUES TO TODATE OF DCLTBPET011
           ELSE
              MOVE 0 TO TODATE-IND OF DCLTBPET011
              MOVE FUNCTION DISPLAY-OF(TODATE OF W-LPETM011) TO
                   TODATE OF DCLTBPET011
           END-IF
           IF ADDRESSLINE1-LEN OF W-LPETM011 = 0
           OR ADDRESSLINE1-TEXT OF W-LPETM011(1:
                ADDRESSLINE1-LEN OF W-LPETM011) = SPACES
           OR ADDRESSLINE1-TEXT OF W-LPETM011(1:
                ADDRESSLINE1-LEN OF W-LPETM011) = LOW-VALUES
           ...
           ELSE
              ...
              MOVE ADDRESSLINE1 OF W-LPETM011 TO
                   ADDRESSLINE1 OF DCLTBPET011
           END-IF
           IF ADDRESSLINE2-LEN OF W-LPETM011 = 0
           OR ADDRESSLINE2-TEXT OF W-LPETM011(1:
                ADDRESSLINE2-LEN OF W-LPETM011) = SPACES
           OR ADDRESSLINE2-TEXT OF W-LPETM011(1:
                ADDRESSLINE2-LEN OF W-LPETM011) = LOW-VALUES
           ...
           ELSE
              ...
              MOVE ADDRESSLINE2 OF W-LPETM011 TO
                   ADDRESSLINE2 OF DCLTBPET011
           END-IF
           IF POSTALCODE-LEN OF W-LPETM011 = 0
           OR POSTALCODE-TEXT OF W-LPETM011(1:
                POSTALCODE-LEN OF W-LPETM011) = SPACES
           OR POSTALCODE-TEXT OF W-LPETM011(1:
                POSTALCODE-LEN OF W-LPETM011) = LOW-VALUES
           ...
           ELSE
              ...
              MOVE POSTALCODE OF W-LPETM011 TO POSTALCODE OF DCLTBPET011
           END-IF
           IF CITY-LEN OF W-LPETM011 = 0
           OR CITY-TEXT OF W-LPETM011(1:CITY-LEN OF W-LPETM011) = SPACES
           OR CITY-TEXT OF W-LPETM011(1:CITY-LEN OF W-LPETM011) =
                LOW-VALUES
           ...
           ELSE
              ...
              MOVE CITY OF W-LPETM011 TO CITY OF DCLTBPET011
           END-IF
           IF REGION-LEN OF W-LPETM011 = 0
           OR REGION-TEXT OF W-LPETM011(1:REGION-LEN OF W-LPETM011) =
                SPACES
           OR REGION-TEXT OF W-LPETM011(1:REGION-LEN OF W-LPETM011) =
                LOW-VALUES
           ...
           ELSE
              ...
              MOVE REGION OF W-LPETM011 TO REGION OF DCLTBPET011
           END-IF
           IF COUNTRY-LEN OF W-LPETM011 = 0
           OR COUNTRY-TEXT OF W-LPETM011(1:
                COUNTRY-LEN OF W-LPETM011) = SPACES
           OR COUNTRY-TEXT OF W-LPETM011(1:
                COUNTRY-LEN OF W-LPETM011) = LOW-VALUES
           ...
           ELSE
              ...
              MOVE COUNTRY OF W-LPETM011 TO COUNTRY OF DCLTBPET011
           END-IF
           MOVE CREATEDBY    OF W-LPETM011 TO CREATEDBY   OF DCLTBPET011
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETM011) TO
              CREATEDDATE OF DCLTBPET011
           MOVE UPDATEDBY    OF W-LPETM011 TO UPDATEDBY   OF DCLTBPET011
           MOVE FUNCTION DISPLAY-OF(UPDATEDDATE OF W-LPETM011) TO
