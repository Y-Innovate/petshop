      ...
      *===============================================================*
       ...
       PROCEDURE DIVISION USING P-LPETM007.
       MAIN SECTION.
           PERFORM R001-INIT
      ...
      *===============================================================*
       R001-INIT SECTION.
           MOVE P-LPETM007 TO W-LPETM007

           MOVE N'00' TO RETURNCODE OF W-LPETM007
           MOVE N'00' TO REASONCODE OF W-LPETM007
           MOVE SPACES TO INFOMESSAGE OF W-LPETM007
           .
       R001-INIT-END.
           EXIT.
      ...
      *===============================================================*
       R002-CHECKPARM SECTION.
           IF  OPCODE OF W-LPETM007 NOT = N'C'
           AND OPCODE OF W-LPETM007 NOT = N'R'
           AND OPCODE OF W-LPETM007 NOT = N'U'
           AND OPCODE OF W-LPETM007 NOT = N'D'
              MOVE N'08' TO RETURNCODE OF W-LPETM007
              MOVE N'01' TO REASONCODE OF W-LPETM007
              MOVE N'OPCODE is invalid' TO INFOMESSAGE OF W-LPETM007
           END-IF
           ...
           AND OPCODE OF W-LPETM007 NOT = N'R'
              ...
              AND PADID OF W-LPETM007 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM007
                 MOVE N'02' TO REASONCODE OF W-LPETM007
           ...
           OR OPCODE OF W-LPETM007 = N'U'
              ...
              AND STOREID OF W-LPETM007 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM007
                 MOVE N'03' TO REASONCODE OF W-LPETM007
              ...
              IF  RETURNCODE OF W-LPETM007 = N'00'
              AND PRICE      OF W-LPETM007 = 0
              AND DISCOUNT   OF W-LPETM007 = 0
                 MOVE N'08' TO RETURNCODE OF W-LPETM007
                 MOVE N'05' TO REASONCODE OF W-LPETM007
       ...
       R110-INSERT SECTION.
           ...
           WHEN 0
              ...
              MOVE CREATEDDATE OF DCLTBPET007 TO
                   CREATEDDATE OF W-LPETM007
              MOVE UPDATEDDATE OF DCLTBPET007 TO
                   UPDATEDDATE OF W-LPETM007
           WHEN -803
              MOVE N'08' TO RETURNCODE OF W-LPETM007
           ...
           WHEN OTHER
              ...
              STRING N'INSERT gave SQLCODE='
                 ...
                 DELIMITED BY SIZE
                 INTO INFOMESSAGE OF W-LPETM007
      ...
      *===============================================================*
       R120-SELECT SECTION.
           MOVE PADID OF W-LPETM007 TO PADID OF DCLTBPET007
           ...
           EVALUATE SQLCODE
           WHEN 0
              MOVE PADID   OF DCLTBPET007 TO PADID   OF W-LPETM007
              MOVE STOREID OF DCLTBPET007 TO STOREID OF W-LPETM007
              IF PRODUCTID-IND OF DCLTBPET007 < 0
                 MOVE 0 TO PRODUCTID OF W-LPETM007
              ELSE
                 MOVE PRODUCTID OF DCLTBPET007 TO
                      PRODUCTID OF W-LPETM007
              END-IF
              IF ANIMALID-IND OF DCLTBPET007 < 0
                 MOVE 0 TO ANIMALID OF W-LPETM007
              ELSE
                 MOVE ANIMALID OF DCLTBPET007 TO ANIMALID OF W-LPETM007
              END-IF
              IF PRICE-IND OF DCLTBPET007 < 0
                 MOVE 0 TO PRICE OF W-LPETM007
              ELSE
                 MOVE PRICE OF DCLTBPET007 TO PRICE OF W-LPETM007
              END-IF
              IF DISCOUNT-IND OF DCLTBPET007 < 0
                 MOVE 0 TO DISCOUNT OF W-LPETM007
              ELSE
              ...
              MOVE UPDATEDDATE  OF DCLTBPET007 TO
                   UPDATEDDATE  OF W-LPETM007
           WHEN 100
                MOVE N'04' TO RETURNCODE OF W-LPETM007
                MOVE N'01' TO REASONCODE OF W-LPETM007
                MOVE N'TBPET007 entry not found' TO
                   INFOMESSAGE OF W-LPETM007
           WHEN OTHER
                MOVE N'08' TO RETURNCODE OF W-LPETM007
                MOVE N'21' TO REASONCODE OF W-LPETM007
      ...
      *===============================================================*
       R130-UPDATE SECTION.
           ...
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETM007
              MOVE N'32' TO REASONCODE OF W-LPETM007
      ...
      *===============================================================*
       R140-DELETE SECTION.
           ...
           WHEN 100
              MOVE N'08' TO RETURNCODE OF W-LPETM007
              MOVE N'41' TO REASONCODE OF W-LPETM007
              MOVE N'TBPET007 entry not found' TO
                   INFOMESSAGE OF W-LPETM007
           WHEN OTHER
              MOVE N'08' TO RETURNCODE OF W-LPETM007
              MOVE N'42' TO REASONCODE OF W-LPETM007
      ...
      *===============================================================*
       R210-COPY-TO-DCL SECTION.
           MOVE PADID   OF W-LPETM007 TO PADID   OF DCLTBPET007
           MOVE STOREID OF W-LPETM007 TO STOREID OF DCLTBPET007
           IF PRODUCTID OF W-LPETM007 = 0
              MOVE -1 TO PRODUCTID-IND OF DCLTBPET007
           ELSE
              MOVE 0 TO PRODUCTID-IND OF DCLTBPET007
              MOVE PRODUCTID OF W-LPETM007 TO PRODUCTID OF DCLTBPET007
           END-IF
           IF ANIMALID OF W-LPETM007 = 0
              MOVE -1 TO ANIMALID-IND OF DCLTBPET007
           ELSE
              MOVE 0 TO ANIMALID-IND OF DCLTBPET007
              MOVE ANIMALID OF W-LPETM007 TO ANIMALID OF DCLTBPET007
           END-IF
           IF PRICE OF W-LPETM007 = 0
              MOVE -1 TO PRICE-IND OF DCLTBPET007
           ELSE
              MOVE 0 TO PRICE-IND OF DCLTBPET007
              MOVE PRICE OF W-LPETM007 TO PRICE OF DCLTBPET007
           END-IF
           IF DISCOUNT OF W-LPETM007 = 0
           ...
           END-IF
           MOVE CREATEDBY OF W-LPETM007 TO CREATEDBY OF DCLTBPET007
           MOVE FUNCTION DISPLAY-OF(CREATEDDATE OF W-LPETM007) TO
              CREATEDDATE OF DCLTBPET007
           MOVE UPDATEDBY OF W-LPETM007 TO UPDATEDBY OF DCLTBPET007
