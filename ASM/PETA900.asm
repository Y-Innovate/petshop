...
* 
         COPY  DFHEIBLK
*
PETA900  CEEENTRY AUTO=WORKDSA_SIZ,MAIN=NO,BASE=R11
*
         USING WORKDSA,R13
*
         ST    R1,PARML_PTR
...
*
         ...
         USING LPETA900,R8
*
         MVC   LPETA900_RETURNCODE,=CU'00'
         MVC   LPETA900_REASONCODE,=CU'00'
         XR    R0,R0
         XR    R1,R1
         LA    R2,LPETA900_INFOMESSAGE
         LA    R3,L'LPETA900_INFOMESSAGE+L'LPETA900_USERID
         MVCLU R2,R0,X'020'
*
         XR    R7,R7
...
LPETA900                    DSECT
*
LPETA900_RETURNCODE         DS    CUL4
LPETA900_REASONCODE         DS    CUL4
LPETA900_INFOMESSAGE        DS    CUL144
LPETA900_USERID             DS    CUL16
*
LPETA900_SIZ                EQU   *-LPETA900
*
         PUSH  PRINT
         PRINT OFF
         IHAASCB DSECT=YES
